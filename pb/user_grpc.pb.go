...
type UserServiceClient interface {
	...
	AddUserBidirectionalStream(ctx context.Context, opts ...grpc.CallOption) (UserService_AddUserBidirectionalStreamClient, error)
}
...
func (c *userServiceClient) AddUserBidirectionalStream(ctx context.Context, opts ...grpc.CallOption) (UserService_AddUserBidirectionalStreamClient, error) {
	stream, err := c.cc.NewStream(ctx, &UserService_ServiceDesc.Streams[2], "/pb.UserService/AddUserBidirectionalStream", opts...)
	if err != nil {
		return nil, err
	}
	x := &userServiceAddUserBidirectionalStreamClient{stream}
	return x, nil
}

type UserService_AddUserBidirectionalStreamClient interface {
	Send(*User) error
	Recv() (*UserResultStream, error)
	grpc.ClientStream
}

type userServiceAddUserBidirectionalStreamClient struct {
	grpc.ClientStream
}

func (x *userServiceAddUserBidirectionalStreamClient) Send(m *User) error {
	return x.ClientStream.SendMsg(m)
}

func (x *userServiceAddUserBidirectionalStreamClient) Recv() (*UserResultStream, error) {
	m := new(UserResultStream)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
type UserServiceServer interface {
	...
	AddUserBidirectionalStream(UserService_AddUserBidirectionalStreamServer) error
...
func (UnimplementedUserServiceServer) AddUserBidirectionalStream(UserService_AddUserBidirectionalStreamServer) error {
	return status.Errorf(codes.Unimplemented, "method AddUserBidirectionalStream not implemented")
}
...
func _UserService_AddUserBidirectionalStream_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(UserServiceServer).AddUserBidirectionalStream(&userServiceAddUserBidirectionalStreamServer{stream})
}

type UserService_AddUserBidirectionalStreamServer interface {
	Send(*UserResultStream) error
	Recv() (*User, error)
	grpc.ServerStream
}

type userServiceAddUserBidirectionalStreamServer struct {
	grpc.ServerStream
}

func (x *userServiceAddUserBidirectionalStreamServer) Send(m *UserResultStream) error {
	return x.ServerStream.SendMsg(m)
}

func (x *userServiceAddUserBidirectionalStreamServer) Recv() (*User, error) {
	m := new(User)
	if err := x.ServerStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
var UserService_ServiceDesc = grpc.ServiceDesc{
	...
	Streams: []grpc.StreamDesc{
		...
		{
			StreamName:    "AddUserBidirectionalStream",
			Handler:       _UserService_AddUserBidirectionalStream_Handler,
			ServerStreams: true,
			ClientStreams: true,
		},
	},
